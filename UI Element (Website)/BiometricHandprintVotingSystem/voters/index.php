        ...
        <div class="col-12">
            ...
            <?php 
                        ...
                        <table class="table">
                            ...
                            <?php 
                                ...
                                while($candidateData = mysqli_fetch_assoc($fetchingCandidates))
                                {
                                    ...
                                    $fetchingVotes = mysqli_query($db, "SELECT * FROM votes WHERE candidate_id = '". $candidate_id . "'") or die(mysqli_error($db));
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                    <?php
                                            $checkIfVoteCasted = mysqli_query($db, "SELECT * FROM votes WHERE voter_id = '". $_SESSION['user_id'] ."' AND election_id = '". $election_id ."'") or die(mysqli_error($db));    
                                    ...
                                    ?>
                                                    ...
                                                    <img src="../assets/images/vote.jpg" width="100px;">
                                    <?php
                                                }
                                            }else {
                                    ?>
                ...
                <?php
                    ...
                    echo "There are no active elections yet.";
                }
            ?>
