...
<html>
<head>
	<title>Login - Biometric Handprint Voting System</title>
		...
		<div class="d-flex justify-content-center h-100">
			<div class="user_card">
                        ...
                        <div class="d-flex justify-content-center form_container">
                            <form method="POST">
                                ...
                                <div class="input-group mb-2">
                                    ...
                                    <input type="text" name="su_nic_no" class="form-control input_pass" placeholder="NIC No." required />
                                </div>
                                <div class="input-group mb-2">
                                    <div class="input-group-append">
                                        <span class="input-group-text"><i class="fas fa-key"></i></span>
                ...
                ?>
                        <div class="d-flex justify-content-center form_container">
                            <form method="POST">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="nic_no" class="form-control input_user" placeholder="NIC No." required />
                                </div>
                                <div class="input-group mb-2">
                                    <div class="input-group-append">
                                        <span class="input-group-text"><i class="fas fa-key"></i></span>
                        ...
                        <div class="mt-4">
                            <div class="d-flex justify-content-center links text-white">
                                Don't have an account? <a href="handprint_registration.php" class="ml-2 text-white">Sign Up</a>
                            </div>
                            <div class="d-flex justify-content-center links">
                                <a href="handprint_login.php" class="text-white">Login using Handprints</a>
                            </div>
                        </div>
                <?php
                    }
...
<?php 
    ...
    if(isset($_POST['sign_up_btn']))
    {
        ...
        $su_nic_no = mysqli_real_escape_string($db, $_POST['su_nic_no']);
        ...
        if($su_password == $su_retype_password)
        {
            ...
            mysqli_query($db, "INSERT INTO users(username, nic_no, password, user_role) VALUES('". $su_username ."', '". $su_nic_no ."', '". $su_password ."', '". $user_role ."')") or die(mysqli_error($db));
    ...
    }else if(isset($_POST['loginBtn']))
    {
        ...
        // Query Fetch / SELECT
        $fetchingData = mysqli_query($db, "SELECT * FROM users WHERE nic_no = '". $nic_no ."'") or die(mysqli_error($db));
        ...
        if(mysqli_num_rows($fetchingData) > 0)
        {
            ...
            if($nic_no == $data['nic_no'] AND $password == $data['password'])
            {
                session_start();
