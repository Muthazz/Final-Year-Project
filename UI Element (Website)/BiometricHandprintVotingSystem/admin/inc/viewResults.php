        ...
        <div class="col-12">
            ...
            <?php 
                ...
                <?php
                    ...
                    echo "There are no active elections.";
                }
            ?>
            ...
            <?php 
                $fetchingVoteDetails = mysqli_query($db, "SELECT * FROM votes WHERE election_id = '". $election_id ."'");
            ...
            <?php
                ...
                <?php
                        ...
                        echo "There are no vote details available!";
                    }
